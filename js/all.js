...
function displayTrendingContent(data) {
  ...
  data.forEach(function(drama, index) {
    ...
    let arrayIndexEmpat = [9, 14]; 
    let arrayIndexLima = [7, 10, 11, 12];
    let arrayIndexEnam = [13];
    let arrayIndexTujuh = [6, 8];
    let arrayIndexDelapan = [5];
  ...
  if (arrayIndex.includes(index)) {
    ...
    title.classList.add('teks-for-trending');
  }else if (arrayIndexLima.includes(index)) {
    title.classList.add('teks-five-trending');
  }else if (arrayIndexEnam.includes(index)) {
    title.classList.add('teks-six-trending');
  }else if (arrayIndexTujuh.includes(index)) {
    title.classList.add('teks-seven-trending');
  }else if (arrayIndexDelapan.includes(index)) {
    title.classList.add('teks-eight-trending');
  }
    ...
    if (index === 4 ) {
        ...
        const titlePart2 = drama.title.substring(11, 23);
        ...
        // Potong title menjadi dua bagian pada index ke-4
        const titlePart1 = drama.title.substring(0, 12);
        const titlePart2 = drama.title.substring(12, 22);
        ...
        // Potong title menjadi dua bagian pada index ke-4
        const titlePart1 = drama.title.substring(0, 12);
        const titlePart2 = drama.title.substring(12, 21);
...
//===========================================================================================//
//=========================== Fungsi untuk menampilkan konten New Release ===================//
//===========================================================================================//
...
function displayPopulerContent(data) {
  ...
  data.forEach(function(drama, index) {
    ...
    // Array indeks yang ingin di style;
    let arrayIndex = [1 , 6, 8, 12];
     let arrayIndexDua = [2, 7, 9];
     let arrayIndexTiga = [3, 11];
     let arrayIndexEmpat = [4];
     let arrayIndexNol = [0, 14];
  ...
  if (index === 3  ) {
    ...
    // Potong title menjadi dua bagian pada index ke-4
    const titlePart1 = drama.title.substring(0, 10);
    const titlePart2 = drama.title.substring(10, 22);
...
function displayRomanceContent(data) {
  ...
  data.forEach(function(drama, index) {
    ...
    if (index === 3) {
      ...
      const titlePart2 = drama.title.substring(18, 31);
...
function displayActionContent(data) {
  ...
  data.forEach(function(drama, index) {
    ...
    let arrayIndex = [0, 5, 8, 11];
    let arrayIndexDua = [1];
    let arrayIndexTiga = [2]
    let arrayIndexEmpat = [3];
    let arrayIndexLima = [12, 13];
    let arrayIndexEnam = [14];
    let arrayIndexTujuh = [6, 7, 9, 10];
    ...
    if (arrayIndex.includes(index)) {
      ...
      title.classList.add('teks-five-recom');
    }else if (arrayIndexEnam.includes(index)) {
      title.classList.add('teks-six-recom');
    }else if (arrayIndexTujuh.includes(index)) {
      title.classList.add('teks-seven-recom');
    }
    ...
    if (index === 2) {
      ...
      // Potong title menjadi dua bagian pada index ke-4
      const titlePart1 = drama.title.substring(0, 11);
      const titlePart2 = drama.title.substring(11, 20);
